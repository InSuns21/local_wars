...
- ファイルを変更したとき、現在のgitの変更差分から[コミットメッセージ] 具体的なコミットメッセージを日本語で考えること
...
- [docs/product-specs/ai-self-play-improvement-loop.md](docs/product-specs/ai-self-play-improvement-loop.md): AI 同士の自己対戦、レポート読解、改修、再検証を反復する改善ループの草案仕様
