...
### 高優先度
- 自爆ドローンと対ドローン防空ルール未実装
  - 現象: 工場起点の使い捨て航空戦力、迎撃、防空歩兵、ドローン向け設定が存在しない
  - 影響: 低コスト飽和戦術と対ドローン防御の新しい戦術レイヤーを試せない
  - 次の打ち手: [active/2026-03-08-suicide-drones-and-counter-drone.md](active/2026-03-08-suicide-drones-and-counter-drone.md) に沿って実装する
- 補給ユニットと補給コマンド未実装
...
- 効果音SE未導入
  - 現象: 決定、取消、エラー、移動、攻撃、被弾、撃破の即時フィードバックがない
  - 影響: 操作の確定感とゲームらしさが弱く、戦闘結果の把握も遅い
  - 次の打ち手: [active/2026-03-09-sound-effects.md](active/2026-03-09-sound-effects.md) に沿って実装する

### 中優先度
- 海上ユニットと港湾ルール未実装
  - 現象: 駆逐艦、揚陸艦、空母、潜水艦、戦艦、補給艦の定義はあるが、`SEA / PORT` と接続された実装は未完了
  - 影響: 海戦、上陸戦、沿岸砲撃、海上補給、艦載機運用を遊べない
  - 次の打ち手: [active/2026-03-10-naval-units-and-ports.md](active/2026-03-10-naval-units-and-ports.md) に沿って実装する
- 輸送ユニットと搭載ルール未実装
