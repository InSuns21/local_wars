...
const BASIC_STEPS = [
  ...
  {
    title: '4. 盤面凡例と経過ログで結果を確認する',
    body: '色や線の意味は `盤面凡例` で確認できます。行動結果は `経過ログ` と `最終コマンド` に反映されます。',
  },
  {
    title: '5. ターン終了で相手手番へ進める',
    body: '移動や生産を終えたら上部バーの `ターン終了` を押します。これで最初の1ターンを一通り進められます。',
  },
];
...
const DETAILED_RULES = [
  ...
  },
  {
    ...
    items: [
      ...
      '工場は空いている自軍マスなら生産可能で、長期戦では所有数が差になります。',
    ],
  },
  {
    title: '補給と索敵',
            ...
            <>
              ...
              <Box component="section" aria-label="画面上の見どころ">
                ...
                <Stack spacing={1.5}>
                  ...
                  <Paper variant="outlined" sx={{ p: 1.5 }}>
                    ...
                    <Typography variant="body2">移動、攻撃、占領、生産の判断をまとめる場所です。移動先を選んだ後に確認します。</Typography>
                  </Paper>
                  <Paper variant="outlined" sx={{ p: 1.5 }}>
              ...
              <Paper variant="outlined" sx={{ p: 1.5 }}>
                ...
                <Typography variant="body2">
                  この画面を閉じたら `はじめから` で標準マップを選び、歩兵で都市を取りながら最初の1ターンを試してください。
                </Typography>
              </Paper>
            </>
          )}
