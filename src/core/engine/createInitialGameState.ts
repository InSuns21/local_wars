...
const applyFeatureToggles = (state: GameState, settings?: GameSettings): GameState => {
  ...
  return {
    ...
    enableAirUnits: settings.enableAirUnits,
    enableNavalUnits: settings.enableNavalUnits,
...
export const createInitialGameState = (options: GameInitializationOptions = {}): GameState => {
  ...
  const base: GameState = {
    ...
    enableAirUnits: options.settings?.enableAirUnits ?? true,
    enableNavalUnits: options.settings?.enableNavalUnits ?? true,
