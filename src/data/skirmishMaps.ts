...
const TEMPLATES: SkirmishTemplate[] = [
  ...
  },
  {
    ...
    tiles: [
      ...
      { x: 9, y: 8, terrainType: 'AIRPORT', owner: 'P2' },
    ...
    units: [
      ...
      { id: 'p2_inf', owner: 'P2', type: 'INFANTRY', x: 9, y: 7 },
      { id: 'p2_tank', owner: 'P2', type: 'TANK', x: 9, y: 6 },
      { id: 'p2_fighter', owner: 'P2', type: 'FIGHTER', x: 9, y: 8 },
    ],
  },
  {
    id: 'runway-rush',
    ...
    tiles: [
      ...
      { x: 12, y: 7, terrainType: 'FACTORY', owner: 'P2' },
      { x: 2, y: 1, terrainType: 'AIRPORT', owner: 'P1' },
      { x: 11, y: 8, terrainType: 'AIRPORT', owner: 'P2' },
      { x: 6, y: 4, terrainType: 'AIRPORT' },
      { x: 7, y: 4, terrainType: 'AIRPORT' },
      { x: 5, y: 4, terrainType: 'ROAD' },
      { x: 8, y: 4, terrainType: 'ROAD' },
      { x: 6, y: 5, terrainType: 'ROAD' },
      { x: 7, y: 5, terrainType: 'ROAD' },
      ...
      { x: 9, y: 4, terrainType: 'CITY', owner: 'P2' },
    ],
    units: [
      { id: 'p1_inf', owner: 'P1', type: 'INFANTRY', x: 2, y: 3 },
      ...
      { id: 'p2_inf', owner: 'P2', type: 'INFANTRY', x: 11, y: 6 },
      { id: 'p2_recon', owner: 'P2', type: 'RECON', x: 10, y: 6 },
      { id: 'p2_attacker', owner: 'P2', type: 'ATTACKER', x: 11, y: 8 },
    ],
  },
  {
    id: 'triple-runways',
    ...
    tiles: [
      ...
      { x: 2, y: 1, terrainType: 'FACTORY', owner: 'P1' },
      { x: 13, y: 10, terrainType: 'FACTORY', owner: 'P2' },
      { x: 2, y: 2, terrainType: 'AIRPORT', owner: 'P1' },
      { x: 13, y: 9, terrainType: 'AIRPORT', owner: 'P2' },
      { x: 7, y: 5, terrainType: 'AIRPORT' },
      { x: 8, y: 6, terrainType: 'AIRPORT' },
      { x: 7, y: 6, terrainType: 'ROAD' },
      { x: 8, y: 5, terrainType: 'ROAD' },
      { x: 6, y: 5, terrainType: 'ROAD' },
      { x: 9, y: 6, terrainType: 'ROAD' },
      { x: 5, y: 4, terrainType: 'CITY', owner: 'P1' },
      { x: 10, y: 7, terrainType: 'CITY', owner: 'P2' },
      { x: 6, y: 4, terrainType: 'FOREST' },
      { x: 9, y: 7, terrainType: 'FOREST' },
      { x: 6, y: 7, terrainType: 'MOUNTAIN' },
    ...
    units: [
      ...
      { id: 'p2_inf', owner: 'P2', type: 'INFANTRY', x: 12, y: 9 },
      { id: 'p2_tank', owner: 'P2', type: 'TANK', x: 11, y: 8 },
      { id: 'p2_bomber', owner: 'P2', type: 'BOMBER', x: 13, y: 9 },
      { id: 'p2_fighter', owner: 'P2', type: 'FIGHTER', x: 14, y: 8 },
    ],
  },
  {
    id: 'cloud-wall',
    ...
    tiles: [
      ...
      { x: 14, y: 10, terrainType: 'HQ', owner: 'P2' },
      { x: 1, y: 2, terrainType: 'FACTORY', owner: 'P1' },
      { x: 14, y: 9, terrainType: 'FACTORY', owner: 'P2' },
      { x: 2, y: 1, terrainType: 'AIRPORT', owner: 'P1' },
      { x: 13, y: 10, terrainType: 'AIRPORT', owner: 'P2' },
      { x: 7, y: 3, terrainType: 'AIRPORT' },
      { x: 8, y: 8, terrainType: 'AIRPORT' },
      { x: 4, y: 5, terrainType: 'MOUNTAIN' },
      { x: 5, y: 5, terrainType: 'MOUNTAIN' },
      { x: 10, y: 6, terrainType: 'MOUNTAIN' },
      { x: 11, y: 6, terrainType: 'MOUNTAIN' },
      { x: 6, y: 4, terrainType: 'FOREST' },
      { x: 9, y: 7, terrainType: 'FOREST' },
    ...
    units: [
      ...
      { id: 'p2_inf', owner: 'P2', type: 'INFANTRY', x: 12, y: 8 },
      { id: 'p2_anti_air', owner: 'P2', type: 'ANTI_AIR', x: 11, y: 8 },
      { id: 'p2_bomber', owner: 'P2', type: 'BOMBER', x: 13, y: 10 },
      { id: 'p2_fighter', owner: 'P2', type: 'FIGHTER', x: 12, y: 10 },
    ],
  },
  {
    id: 'stealth-run',
    ...
    tiles: [
      ...
      { x: 2, y: 1, terrainType: 'FACTORY', owner: 'P1' },
      { x: 15, y: 10, terrainType: 'FACTORY', owner: 'P2' },
      { x: 2, y: 2, terrainType: 'AIRPORT', owner: 'P1' },
      { x: 15, y: 9, terrainType: 'AIRPORT', owner: 'P2' },
      { x: 8, y: 5, terrainType: 'CITY' },
      { x: 9, y: 6, terrainType: 'CITY' },
      { x: 8, y: 4, terrainType: 'FOREST' },
      { x: 9, y: 4, terrainType: 'FOREST' },
      { x: 8, y: 7, terrainType: 'FOREST' },
      { x: 9, y: 7, terrainType: 'FOREST' },
      { x: 6, y: 5, terrainType: 'MOUNTAIN' },
      { x: 11, y: 6, terrainType: 'MOUNTAIN' },
      { x: 7, y: 5, terrainType: 'ROAD' },
      { x: 10, y: 6, terrainType: 'ROAD' },
      { x: 7, y: 6, terrainType: 'AIRPORT' },
      { x: 10, y: 5, terrainType: 'AIRPORT' },
    ],
    units: [
      { id: 'p1_inf', owner: 'P1', type: 'INFANTRY', x: 3, y: 2 },
      ...
      { id: 'p2_anti_air', owner: 'P2', type: 'ANTI_AIR', x: 13, y: 9 },
      { id: 'p2_stealth', owner: 'P2', type: 'STEALTH_BOMBER', x: 15, y: 9 },
      { id: 'p2_fighter', owner: 'P2', type: 'FIGHTER', x: 14, y: 10 },
    ],
  },
];
