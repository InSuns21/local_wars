...
const TEMPLATES: SkirmishTemplate[] = [
  ...
  },
  {
    ...
    tiles: [
      ...
      { x: 1, y: 2, terrainType: 'FACTORY', owner: 'P1' },
      { x: 16, y: 9, terrainType: 'FACTORY', owner: 'P2' },
      { x: 3, y: 3, terrainType: 'CITY', owner: 'P1' },
  ...
  },
  {
    ...
    tiles: [
      ...
      { x: 16, y: 14, terrainType: 'HQ', owner: 'P2' },
      { x: 1, y: 2, terrainType: 'FACTORY', owner: 'P1' },
      { x: 16, y: 13, terrainType: 'FACTORY', owner: 'P2' },
      { x: 2, y: 1, terrainType: 'AIRPORT', owner: 'P1' },
  ...
  },
  {
    ...
    tiles: [
      ...
      { x: 1, y: 2, terrainType: 'FACTORY', owner: 'P1' },
      { x: 16, y: 11, terrainType: 'FACTORY', owner: 'P2' },
      { x: 2, y: 1, terrainType: 'AIRPORT', owner: 'P1' },
  ...
  },
  {
    ...
    tiles: [
      ...
      { x: 1, y: 2, terrainType: 'FACTORY', owner: 'P1' },
      { x: 16, y: 11, terrainType: 'FACTORY', owner: 'P2' },
      { x: 2, y: 3, terrainType: 'PORT', owner: 'P1' },
      { x: 15, y: 10, terrainType: 'PORT', owner: 'P2' },
      { x: 4, y: 4, terrainType: 'FACTORY', owner: 'P1' },
      { x: 13, y: 9, terrainType: 'FACTORY', owner: 'P2' },
      { x: 7, y: 6, terrainType: 'CITY' },
      { x: 8, y: 7, terrainType: 'CITY' },
      { x: 10, y: 7, terrainType: 'CITY' },
      ...
      { x: 9, y: 6, terrainType: 'ROAD' },
      { x: 10, y: 6, terrainType: 'ROAD' },
      { x: 11, y: 7, terrainType: 'ROAD' },
      { x: 12, y: 8, terrainType: 'ROAD' },
      { x: 0, y: 4, terrainType: 'SEA' },
      { x: 0, y: 5, terrainType: 'SEA' },
      { x: 0, y: 6, terrainType: 'SEA' },
      { x: 1, y: 4, terrainType: 'SEA' },
      { x: 1, y: 5, terrainType: 'SEA' },
      { x: 1, y: 6, terrainType: 'SEA' },
      { x: 16, y: 7, terrainType: 'SEA' },
      { x: 16, y: 8, terrainType: 'SEA' },
      { x: 16, y: 9, terrainType: 'SEA' },
      { x: 17, y: 7, terrainType: 'SEA' },
      { x: 17, y: 8, terrainType: 'SEA' },
      { x: 17, y: 9, terrainType: 'SEA' },
      { x: 6, y: 7, terrainType: 'FOREST' },
      { x: 12, y: 6, terrainType: 'FOREST' },
    ],
    units: [
      { id: 'p1_inf', owner: 'P1', type: 'INFANTRY', x: 3, y: 4 },
      { id: 'p1_destroyer', owner: 'P1', type: 'DESTROYER', x: 2, y: 5 },
      { id: 'p1_tank', owner: 'P1', type: 'TANK', x: 4, y: 5 },
      { id: 'p2_inf', owner: 'P2', type: 'INFANTRY', x: 14, y: 9 },
      { id: 'p2_destroyer', owner: 'P2', type: 'DESTROYER', x: 15, y: 8 },
...
const MAP_METADATA: Record<string, Omit<MapMeta, 'id' | 'name' | 'width' | 'height'>> = {
  ...
  'coastal-drone-raid': {
    difficulty: 'challenging',
    estimatedMinutes: 32,
    victoryHint: '港と艦艇に圧をかけられるため、沿岸の工場線を守れないと一気に崩れやすい。',
    featureTags: ['沿岸戦', '対艦奇襲', '港湾防衛'],
    summary: '海上ユニットもドローンの脅威に入るため、沿岸防衛と内陸工場の両立が問われる。',
    recommendedFor: '対艦ドローン運用を試したい人',
  },
};
